...
if mode == "add":
    ...
    with st.form("add_cust"):
        ...
        errs=[]
        if not cname.strip(): errs.append("Company Name is required.")
        if not contact.strip(): errs.append("Contact Name is required.")
